...
* Online sources are sparse and untargeted 
    + BRERC, iNaturalist
...
* Identify indicator species matrix (pollinators + ...)
* Establish baseline and trajectory
* Species surveys to track progress (eDNA, acoustic)
    + Expensive
...
* Biodegradeable QR codes at key sites and walks
* Record indicator species data: (count, species, timestamp, location)
* Promote - (EU) Pollinator Week, City Nature Challenge, bioblitz
* Build on Round 1 Pollinator Fund projects
* Criterion for Round 2 funding?
* Scalable - can extend by species and location
...
* Supports key strategy commitments
